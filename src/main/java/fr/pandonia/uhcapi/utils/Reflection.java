...
public class Reflection {
    public static void playSound(Player player, Location location, String soundName, float volume, float pitch) {
        try {
            ...
            Method playSoundMethod = getMethod(player.getClass(), "playSound", new Class[] { Location.class, Sound.class, float.class, float.class });
            playSoundMethod.invoke(player, new Object[] { location, sound, Float.valueOf(volume), Float.valueOf(pitch) });
    ...
    public static void sendPacket(Player player, Object packet) {
        try {
            ...
            Method sendPacketMethod = getMethod(playerConnectionField.getType(), "sendPacket", new Class[] { packetClass });
